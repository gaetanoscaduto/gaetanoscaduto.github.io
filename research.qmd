...
In October 2025 I started a new adventure at the [Erasmus Institute on Culture and Stratification](https://www.eur.nl/essb/informatie-voor/onderzoekers/erasmus-institute-culture-and-stratification) within Erasmus University Rotterdam (EUR). I worked on a project named "Understanding the different meanings of climate change among the public" under the supervision of Willem de Koster.

![The view of Rotterdam from EUR](images/rotterdam.jpeg){width="323"}

From July 2026, I am an Assistant Professor at Tilburg University. My life abruptly changed: I am about to move to the Netherlands and started the next chapter of this story!

In my free time, I still love **writing** and **learning languages**. I am currently <i class="fas fa-download pr-1 fa-fw"></i><a href="deelcertificaat_nederlands.pdf" target="_blank" rel="noopener"> learning Dutch </a>, which helps me a lot given that I live in Flanders and work in the Netherlands.
